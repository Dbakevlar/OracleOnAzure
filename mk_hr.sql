...
DEFINE log_path = &5
PROMPT
PROMPT specify the connection string or service for db as parameter 6:
DEFINE dbcs = &6
...
*/
CONN hr/&pass@//localhost:1521/&dbcs
SET FEEDBACK 1
SET NUMWIDTH 10
SET LINESIZE 80
SET TRIMSPOOL ON
...
COMMIT;
5. Create procedural objects
Run below scripts to create HR schema procedures
...
/
COMMIT;
/* 6. Add comments to tables & columns */
SET FEEDBACK 1
SET NUMWIDTH 10
SET LINESIZE 80
SET TRIMSPOOL ON
